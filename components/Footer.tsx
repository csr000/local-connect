...
const Footer = () => {
  return (
    <footer className="bg-gray-50 text-center text-gray-600 lg:text-left">
      <div className="flex items-center justify-center border-b-2 border-gray-200 p-6 lg:justify-between max-container padding-container">
        ...
        <div className="flex justify-center">
          ...
          <a href="#!" className="mr-6">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 488 512" className="h-4 w-4">
      ...
      <div className="mx-6 py-10 text-center md:text-left max-container padding-container">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <p className="lg:w-[80%]">
              LocalConnect is your AI-powered guide to discovering local businesses that fit your preferences. Explore
              your neighborhood like never before with personalized recommendations and real-time promotions.
            </p>
          </div>

          <div>
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">Discover</h6>
            <p className="mb-4">
      ...
      <div className="bg-gray-100 p-6 text-center">
        <span>© 2025 LocalConnect</span>
        <a className="font-semibold" href="https://localconnect.com/">
          {" "}
          localconnect.com
        </a>
      </div>
